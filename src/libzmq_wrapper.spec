...
1 cdecl zmq_atomic_counter_dec() LIBZMQ_WRAPPER_zmq_atomic_counter_dec
2 cdecl zmq_atomic_counter_destroy() LIBZMQ_WRAPPER_zmq_atomic_counter_destroy
3 cdecl zmq_atomic_counter_inc() LIBZMQ_WRAPPER_zmq_atomic_counter_inc
4 cdecl zmq_atomic_counter_new() LIBZMQ_WRAPPER_zmq_atomic_counter_new
5 cdecl zmq_atomic_counter_set() LIBZMQ_WRAPPER_zmq_atomic_counter_set
6 cdecl zmq_atomic_counter_value() LIBZMQ_WRAPPER_zmq_atomic_counter_value
7 cdecl zmq_bind() LIBZMQ_WRAPPER_zmq_bind
8 cdecl zmq_close() LIBZMQ_WRAPPER_zmq_close
...
19 cdecl zmq_curve_keypair( str str ) LIBZMQ_WRAPPER_zmq_curve_keypair
20 cdecl zmq_curve_public( str str ) LIBZMQ_WRAPPER_zmq_curve_public
...
28 cdecl zmq_leave() LIBZMQ_WRAPPER_zmq_leave
29 cdecl zmq_msg_close( ptr ) LIBZMQ_WRAPPER_zmq_msg_close
30 cdecl zmq_msg_copy( ptr ptr ) LIBZMQ_WRAPPER_zmq_msg_copy
31 cdecl zmq_msg_data( ptr ) LIBZMQ_WRAPPER_zmq_msg_data
32 cdecl zmq_msg_get( ptr long ) LIBZMQ_WRAPPER_zmq_msg_get
33 cdecl zmq_msg_gets( ptr str ) LIBZMQ_WRAPPER_zmq_msg_gets
34 cdecl zmq_msg_group( ptr ) LIBZMQ_WRAPPER_zmq_msg_group
35 cdecl zmq_msg_init( ptr ) LIBZMQ_WRAPPER_zmq_msg_init
36 cdecl zmq_msg_init_buffer( ptr ptr long ) LIBZMQ_WRAPPER_zmq_msg_init_buffer
37 cdecl zmq_msg_init_data( ptr ptr long ptr ptr ) LIBZMQ_WRAPPER_zmq_msg_init_data
38 cdecl zmq_msg_init_size( ptr long ) LIBZMQ_WRAPPER_zmq_msg_init_size
39 cdecl zmq_msg_more( ptr ) LIBZMQ_WRAPPER_zmq_msg_more
40 cdecl zmq_msg_move( ptr ptr ) LIBZMQ_WRAPPER_zmq_msg_move
41 cdecl zmq_msg_recv( ptr ptr long ) LIBZMQ_WRAPPER_zmq_msg_recv
42 cdecl zmq_msg_routing_id( ptr ) LIBZMQ_WRAPPER_zmq_msg_routing_id
43 cdecl zmq_msg_send( ptr ptr long ) LIBZMQ_WRAPPER_zmq_msg_send
44 cdecl zmq_msg_set( ptr long long ) LIBZMQ_WRAPPER_zmq_msg_set
45 cdecl zmq_msg_set_group( ptr str ) LIBZMQ_WRAPPER_zmq_msg_set_group
46 cdecl zmq_msg_set_routing_id( ptr long ) LIBZMQ_WRAPPER_zmq_msg_set_routing_id
47 cdecl zmq_msg_size( ptr ) LIBZMQ_WRAPPER_zmq_msg_size
48 cdecl zmq_poll( ptr long long ) LIBZMQ_WRAPPER_zmq_poll
49 cdecl zmq_poller_add() LIBZMQ_WRAPPER_zmq_poller_add
50 cdecl zmq_poller_add_fd() LIBZMQ_WRAPPER_zmq_poller_add_fd
51 cdecl zmq_poller_destroy() LIBZMQ_WRAPPER_zmq_poller_destroy
52 cdecl zmq_poller_fd() LIBZMQ_WRAPPER_zmq_poller_fd
53 cdecl zmq_poller_modify() LIBZMQ_WRAPPER_zmq_poller_modify
54 cdecl zmq_poller_modify_fd() LIBZMQ_WRAPPER_zmq_poller_modify_fd
55 cdecl zmq_poller_new() LIBZMQ_WRAPPER_zmq_poller_new
56 cdecl zmq_poller_remove() LIBZMQ_WRAPPER_zmq_poller_remove
57 cdecl zmq_poller_remove_fd() LIBZMQ_WRAPPER_zmq_poller_remove_fd
